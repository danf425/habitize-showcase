...
function Invoke-Prepare {
  ...
  Copy-Item -Path "z:\Showcase\SW IBM iAccess 7.1\IBM_iAccess_7.1_Prerequisites\vcredist_x64.exe" -Destination "c:\install" -Force
  Copy-Item -Path "z:\Showcase\SW IBM iAccess 7.1\IBM_iAccess_7.1_Prerequisites\vcredist_x86.exe" -Destination "c:\install" -Force
  Copy-Item -Path "z:\Showcase\SW IBM iAccess 7.1\IBM_iAccess_7.1\" -Destination "c:\install\" -Recurse -Force
  Copy-Item -Path "Z:\Showcase\SW IBM iAccess 7.1\IBM_iAccess_7.1_SP55797\" -Destination "c:\install\" -Recurse -Force
  Copy-Item -Path "Z:\Showcase\SW IBM ShowCase 9.0.0.4.1\IBM ShowCase 9.0.0.4" -Destination "c:\install\SC" -Recurse -Force
...
function Invoke-Build {
  ...
  Start-Process "c:\install\vcredist_x86.exe" -ArgumentList "/Q"
  Start-Process "c:\install\vcredist_x64.exe" -ArgumentList "/Q"
...
function Invoke-End {
  Invoke-DefaultEnd
  #TODO  #Turn on Windows Installer RDS compatibility
